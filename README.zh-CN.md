...
<div align="center">
  ...
  <br />
  <sub><b>从一句话开始。</b> Argus 会把宽泛的研究意图收敛成 topic，问关键澄清问题，然后带你选择运行方式。</sub>
</div>
...
<div align="center">
  ...
  <br />
  <sub><b>看着知识图谱长出来。</b> Records、routes、来源关系和薄弱点都会变成可导航的结构，而不是消失在聊天记录里。</sub>
</div>
...
<div align="center">
  ...
  <br />
  <sub><b>阅读持续更新的深度报告。</b> 新证据进来后，Argus 会持续改写 synthesis，并把关键判断引用回结构化 source records。</sub>
</div>
