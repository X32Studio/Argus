...
<div align="center">
  ...
  <br />
  <sub>如果当前页面不显示视频，可以 <a href="asserts/demo.mp4">直接打开演示视频</a>。</sub>
</div>
...
下面这句话是在 **Claude Code 聊天窗口**里输入，不是在系统终端里输入：
...
这是新手路径。保持这个 Claude Code 窗口开着，Argus 就会持续跑研究迭代。你可以在浏览器里打开网页看板：
...
在第一个 Claude Code 窗口里，选择 **Hand off to cron via `/argus loop`** 或 **Just finish topic creation**。
